...
def generate_header(config_json, netlist_info: NetlistInfo, num_outputs):
    ...
    header_file.append(f"    Eigen::Matrix<T, num_states, num_voltages_variable> B_mat_var;")
    header_file.append(f"    Eigen::Vector<T, num_states> B_u_fix;")
    ...
    header_file.append(f"    Eigen::Matrix<T, num_outputs, num_voltages_variable> E_mat_var;")
    header_file.append(f"    Eigen::Vector<T, num_outputs> E_u_fix;")
    ...
    header_file.append(f"    Eigen::Matrix<T, num_nl_ports, num_voltages_variable> H_mat_var;")
    header_file.append(f"    Eigen::Vector<T, num_nl_ports> H_u_fix;")
